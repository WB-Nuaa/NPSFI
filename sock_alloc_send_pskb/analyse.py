...
error_map = {
    ...
    "Errno32: Broken pipe" : 15,
    "Errno512:  Unknown error" : 16,
    "Errno105:  No buffer space available" : 17,
    "RCU" : 18,
    "IPv4: Attempt to release alive inet socket": 19,
    "Tx Unit Hang" : 20,
    "Internal error: ptrace BRK handler": 21,
    "Network TimeOut" : 22,
    "BUG: scheduling while atomic" : 23,
    "SDC" : 24, 
    "Error Port" : 25
}
